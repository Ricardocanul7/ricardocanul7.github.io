<template>
    <section class="bg-slate-900 text-white relative">
        <div class="absolute top-1/2 left-1/10 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-emerald-400/10 rounded-full blur-[100px] pointer-events-none"></div>
        <Container> 
            <div class="flex flex-col lg:flex-row items-center gap-12 py-16">
                <div class="flex-1 text-center lg:text-left">
                    ...
                    <NuxtLink :to="localePath('/projects')"
                        class="inline-flex items-center gap-2 bg-violet-300 hover:bg-violet-300 text-indigo-800 font-medium text-sm px-6 py-3 rounded-xl transition-colors shadow-lg shadow-indigo-600/20 group">
                        {{ $t('homeHero.cta') }}
